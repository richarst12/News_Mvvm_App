...
import com.example.news_mvvm_app.data.model.Source
import com.example.news_mvvm_app.ui.UiState
import com.example.news_mvvm_app.ui.common.ShowError
import com.example.news_mvvm_app.ui.common.ShowLoading
import com.example.news_mvvm_app.ui.utils.AppConstant

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TopHeadlineRoute(
    onNewsClick: (url: String) -> Unit,
    newsViewModel: TopHeadlineViewModel = hiltViewModel()
) {
...
@Composable
fun ArticleList(article: List<Article>, onNewsClick: (url: String) -> Unit){
    LazyColumn {
